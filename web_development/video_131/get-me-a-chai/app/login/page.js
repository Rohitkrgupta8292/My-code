    ...
    <>
      <div className="text-white container mx-auto py-14">
        ...
        <div className="flex flex-col gap-2 p-10 items-center">
          <button className="flex items-center w-64 bg-slate-300  border border-gray-500 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button
            ...
            className="flex items-center w-64 bg-slate-300  border border-gray-500 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
